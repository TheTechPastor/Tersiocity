...
Changing tag names through the entire vault requires the help of a plugin (such as [GitHub - pjeby/tag-wrangler: Rename, merge, toggle, and search tags from the Obsidian tag pane 83](https://github.com/pjeby/tag-wrangler)), or a risky find-and-replace procedure.
